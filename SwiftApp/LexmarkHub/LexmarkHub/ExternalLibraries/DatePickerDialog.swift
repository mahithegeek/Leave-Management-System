...
class DatePickerDialog: UIView {
    ...
    func show(_ title: String, doneButtonTitle: String, cancelButtonTitle: String, defaultDate: Date = Date(), datePickerMode: UIDatePickerMode = .date, minDate:Date?, maxDate:Date?, callback: @escaping DatePickerCallback) {
